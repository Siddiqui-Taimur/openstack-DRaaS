...
# Testing purposes for local machines, set according to your scenario
...
class MasterRequestHandler(SimpleHTTPServer.SimpleHTTPRequestHandler):
	...
	def do_GET(self):
		...
		self.send_response(302)
	       	self.send_header('Location','http://' +aliveServer + ':' +HybridConfigurations.KEYSTONE_PORT + self.path)
	...
	def find_aliveServer(self):
		...
		try:
        		...
        		ans = urllib.urlopen('http://' +primary+ ':' +HybridConfigurations.KEYSTONE_PORT+ '/v2.0/')
